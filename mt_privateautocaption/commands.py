...
async def start_meg(client, update):
    ...
    reply_markup =  InlineKeyboardMarkup( [[
        ...
        InlineKeyboardButton("Owner 👑", url="t.me/iAmLiKu1"),
        InlineKeyboardButton("Channel📢", url="t.me/cs_cloud")
        ]]
    )
...
async def callback_data(client, update: CallbackQuery):
    ...
    if query_data == "about":
        ...
        await update.message.edit_text(
            """<b>➪ Bot Name</b> AutoCaptionBot\n\n➪ <b>Framework : Pyrogram</b>\n\n➪<b> Language : Python</b>\n\n➪<b> Server : Heroku</b> \n\n<b>➪ Version : 2.0.1</b>\n\n<b>➪ Source Code  : <a href="https://github.com/likucs/PrivateAutoCaption">Touch Me 🤗</a>\n\n➪ Developer :  @iAmLiKu1\n\n➪ Credits : <a href="https://github.com/likucs/PrivateAutoCaption/blob/main/mt_privateautocaption/Credits.md">Credits</a></b>""",
            reply_markup=reply_markup,
            parse_mode="html"
        )
